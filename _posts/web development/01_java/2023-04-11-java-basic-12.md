...
<table>
	...
	<tr>
		...
		<td>pathname에 존재하는 물리적 파일을 위한 File 객체 생성</td>
	</tr>
	<tr>
		<td rowspan="5">메소드</td>
...
<table>
	...
	<tr>
		...
		<td>FileWriter 객체 생성: 객체 생성시 파일을 향한 문자 출력 흐름이 만들어짐</td>
	</tr>
	<tr>
		<td rowspan="3">메소드</td>
		<td>void write(String s)</td>
		<td>문자열 s를 파일에 출력</td>
	</tr>
	<tr>
		<td>void write(char[] buf)</td>
...
<table>
	...
	<tr>
		...
		<td>FileReader 객체 생성: 객체 생성시 파일로부터 문자 출력 흐름이 만들어짐</td>
	</tr>
	<tr>
		<td rowspan="3">메소드</td>
		<td>int read()</td>
